...
{
    public class ArchivosViewModel : INotifyPropertyChanged
    {
        ...
        private ArchivoMedico _archivoSeleccionado;
        ...
        public ArchivoMedico ArchivoSeleccionado
        {
        ...
        public ArchivosViewModel(int pacienteId)
        {
        ...
        private void SubirArchivo()
        {
            try
            {
                ...
                if (openFileDialog.ShowDialog() == true)
                {
                    ...
                    var nuevoArchivo = new ArchivoMedico
                    {
                    ...
                    _dbService.CrearArchivoMedico(nuevoArchivo);
                    CargarArchivos();
            ...
            {
                _logService.RegistrarError("ArchivosViewModel.SubirArchivo", ex.Message, ex.StackTrace);
        ...
        private void AbrirArchivo(ArchivoMedico archivo)
        {
            ...
            {
                _logService.RegistrarError("ArchivosViewModel.AbrirArchivo", ex.Message, ex.StackTrace);
                MessageBox.Show("Error: " + ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
            }
        }
        ...
        private void EliminarArchivo(ArchivoMedico archivo)
        {
            ...
            if (result == MessageBoxResult.Yes)
            {
                ...
                {
                    _logService.RegistrarError("ArchivosViewModel.EliminarArchivo", ex.Message, ex.StackTrace);
                    MessageBox.Show("Error: " + ex.Message, "Error", MessageBoxButton.OK, MessageBoxImage.Error);
                }
            }
        }
